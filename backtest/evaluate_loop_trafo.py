...
def denorm_spread(norm_arr, mean, var):
    return norm_arr * math.sqrt(var) + mean
...
def evaluate_loop_trafo(
    ...
    """
    Evaluate a trained Transfomer and encoder with VAE + BOCPD context.
    ...
    for step in trange(T):
        ...
        #action_t = action_t + torch.randn_like(action_t).detach()
